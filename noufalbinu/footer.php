  ...
  <footer>
        <div id='footer-container'>
          <div id='section-3'>
            ...
            <div class='links'>
                 ...
                 <li><a href='http://noufalbinu.com/contact'>Contact</a></li>
                 <li><a href='http://noufalbinu.com/blog'>Blog</a></li>
                 <li><a href='http://noufalbinu.com/portfolio'>Portfolio</a></li>
                 <li><a href='https://www.upwork.com/freelancers/~01ff9bc58dec1f46b6'>Upwork</a></li>
                 </ul>
             </div>
             ...
             <div class='feed'>
                 ...
                 <ul>
                 <li><a href=''>wpAdroit</a></li>
                 <li><a href=''>Tour Pacakge Listing WP Plugin</a></li>
                 <li><a href=''>Local Site Audit</a></li>
                 <li><a href='https://resortdeals.in/'>Resort Deals</a></li>
                 </ul>
             </div>
          </div>
        </div>
    ...
    <div id='footer-cap'>
          ...
          <p>Copyright © <script>document.write(new Date().getFullYear())</script> noufalbinu.com | <a href='/privacy'>Privacy Policy<a></p>
    </div>
   </div>

   <?php wp_footer(); ?>
    
    <script src="<?php echo get_stylesheet_directory_uri(); ?>/text-animation.js"></script>  
